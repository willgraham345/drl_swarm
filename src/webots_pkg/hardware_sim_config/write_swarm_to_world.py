...
A file used to write the configuration of our swarm defined in the src/webots_pkg/config/webots_config.yaml file to a Webots world specified in the same file. Webots worlds are files that define the environment in which the robots will operate. This script will append the configuration of the robots to the world file from the src/webots_pkg/worlds/base_worlds directory.
...
from webots_pkg.swarm_classes import SwarmProtoWriteHelper
