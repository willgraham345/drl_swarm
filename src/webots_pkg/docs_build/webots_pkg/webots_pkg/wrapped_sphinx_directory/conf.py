...
exec(open("/home/will/drl_swarm/src/webots_pkg/docs_build/webots_pkg/webots_pkg/default_sphinx_project/conf.py").read())
...
ensure_global('project', "webots_pkg")
ensure_global('author', "will")
...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    pkgs_to_mock = []
    import importlib
    for exec_depend in ['rclpy', 'launch', 'robot_state_publisher', 'geometry_msgs', 'webots_ros2_driver', 'sensor_msgs', 'nav_msgs', 'diff_drive_controller', 'controller_manager', 'tf2_ros', 'tf_transformations', 'builtin_interfaces', 'joint_state_broadcaster', 'rviz2', 'foxglove_bridge', 'teleop_twist_keyboard']:
        try:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/home/will/drl_swarm/src/webots_pkg/docs_build/webots_pkg/webots_pkg/wrapped_sphinx_directory/generated",
