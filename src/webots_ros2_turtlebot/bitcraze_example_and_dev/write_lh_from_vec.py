...
from cflib.localization.lighthouse_types import Pose # Has translation and rotation matrix
...
if __name__ == '__main__':
    ...
    # This seciton should instead subscribe to a ROS2 topic with LH position and rotation matrix
    """
    ...
    # I think we can omit this. The only thing we'd need to worry about is the calibration data not being valid
