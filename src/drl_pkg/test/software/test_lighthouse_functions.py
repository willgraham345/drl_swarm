...
"""
This file is used to test the functions in drl_pkg/lighthouse_functions.py
...
#RUN_TESTS: Confirm that the functions in drl_pkg/lighthouse_functions.py work as expected
...
from drl_pkg.lighthouse_functions import get_cf_pose_according_to_lh, get_only_cf_kalman_pos, compare_kalman_to_lh_pos
