...
Where I attempted to modify the source code: [lighthouse-position-est source code change](https://github.com/bitcraze/crazyflie-firmware/blob/9e7e697906eced761d5fd27be4f5d866654da250/src/modules/src/lighthouse/lighthouse_position_est.c#L207-L214)

This needs to be removed for yaw estimation to correctly be performed: [yaw calculation](https://github.com/bitcraze/crazyflie-firmware/blob/master/src/utils/src/lighthouse/lighthouse_geometry.c#L169-L201)
